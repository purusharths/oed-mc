...
print("Input Size: ", model.get_input_sizes())
print("Output Size: ", model.get_output_sizes())
...
print("Input Parameters: ", param )
print("Model Output: ", model(param))
...
if model.supports_apply_jacobian():
  print("Jacobian Support Detected. Evaluating Jacobian...\n", model.apply_jacobian(0, 0, param, [1.0, 4.0]))
